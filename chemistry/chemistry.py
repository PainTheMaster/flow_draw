...
header_material = defs.chem_header_material
header_mw = defs.chem_header_MW
header__density = defs.chem_header_density
header_conc_assay = defs.chem_header_conc_assay
...
class Chemistry:
    def __init__(self, df_chem:pd.DataFrame):
        """
